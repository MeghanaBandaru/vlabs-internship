...
** GET all users
   This is the REST API to get all the users
#+BEGIN_SRC python :tangle ../../src/api.py :eval no
...
** GET a user with id
   This is the REST API to get a user by id
#+BEGIN_SRC python :tangle ../../src/api.py :eval no
...
** GET a role with id
   This is the REST API to get a role with id
#+BEGIN_SRC python :tangle ../../src/api.py :eval no
...
** Create a user
   This is the REST API for creating a user
   Usage:
   #+BEGIN_EXAMPLE
   POST request
   {
...
** Create a role
   This is the REST API to create a role
...
** Update/Delete user
   This is the REST API to update and delete a user
*** Implementation
#+BEGIN_SRC python :tangle ../../src/api.py :eval no
...
** Update/Delete a role
   This is the REST API to update and delete a role
*** Implementation
#+BEGIN_SRC python :tangle ../../src/api.py :eval no
...
** Get user by email
   This is the REST API to get user by email
**** Implementation
#+BEGIN_SRC python :tangle ../../src/api.py :eval no
...
** Get email of user
   This is the REST API to get the email of the user
*** Implementation
...
** Get name of user
   This is the REST API to get the name of the user
*** Implementation
...
** Set email of user 
   This is the REST API to set the email of a user
...
** Login/Logout
    This is the REST API for login and logout
    If the user is already logged in then it will redirect to 'user-list.html'
    otherwise it will take us to login.html
